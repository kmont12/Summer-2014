...
class Session:
	...
	def intermediateTest(self): #test for better options
		...
		for c in candidates:
			...
			if (AIBlatency < self.threshold): # if RTT is less than threshold, chosen as intermediate, no more nodes are checked
				...
				break
		self.selectionStarted = False #if nothing is selected
